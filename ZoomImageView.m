...
- (void)setup {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(imageDidChange) name:@"ChangeScrollZoom" object:nil];
}
...
- (void)handleDoubleTap:(UIGestureRecognizer *)gesture
{
    ...
    if(!isClickDouble)
    {
        newScale = _scrollView.zoomScale * 2.5;
        isClickDouble = YES;
    }
    else
    {
...
- (void)dealloc {
    [[NSNotificationCenter defaultCenter] removeObserver:self name: @"ChangeScrollZoom" object:nil];
    [_scrollView.superview removeObserver:self.superview forKeyPath:@"contentOffset"];
}
...
- (void)setImageView:(UIImageView *)imageView {
    if(imageView != _imageView) {
        ...
        [_scrollView.superview addObserver:self.superview forKeyPath:@"contentOffset" options:0 context:nil];
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context {
    if(object == _scrollView.superview) {
